...
The same procedure is then repeated for the probe 2. Finally, the combined table array is then converted into a DynamicTable object using ```util.table2nwb``` function:
```
tbl = [tbl1; tbl2];
...
nwb.units = types.core.Units( ...
  ...
  'electrode_group','electrodes','spike_times','spike_times_index'}, ...
